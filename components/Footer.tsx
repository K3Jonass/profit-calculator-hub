...
const topBlogLinks = [
  { href: "/blog/what-is-mrr", label: "What Is MRR?" },
  {
    ...
    label: "How to Calculate Shopify Profit",
  },
  ...
  { href: "/blog/what-is-subscription-leak", label: "What Is Subscription Leak?" },
  {
    ...
    label: "How to Calculate Revenue Share",
  },
];
...
const contractLinks = [
  ...
  { href: "/contracts/welcome-doc", label: "Client Welcome Document Tool" },
  {
    ...
    label: "Client Access Request Tool",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 md:px-6">
        <section className="rounded-[2rem] border border-slate-200 bg-slate-950 px-6 py-10 text-white shadow-sm md:px-10">
          <h2 className="max-w-3xl text-3xl font-bold tracking-tight md:text-4xl">
            Use calculators, guides, and deal tools together
          </h2>
          <p className="mt-4 max-w-3xl leading-8 text-slate-300">
            ProfitHub connects practical calculators with implementation guides so
            founders, operators, and freelancers can make better money decisions
            faster.
          </p>
        ...
        <div className="motion-fade-up mt-10 grid gap-10 rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm md:grid-cols-2 xl:grid-cols-4 xl:p-10">
        ...
        <div className="mt-8 flex flex-col gap-4 border-t border-slate-200 pt-6 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
          ...
          <p className="text-xs">
            Built for ecommerce sellers, SaaS operators, freelancers, and
      ...
      <div className="flex flex-col gap-3 text-sm text-slate-600">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="transition hover:text-slate-900 animated-link"
          >
            {link.label}
          </Link>
        ))}
