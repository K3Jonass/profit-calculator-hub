...
export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 text-gray-900">
      ...
      <p className="mb-6 leading-8 text-gray-700">After drafting, pressure-test your economics with the Decision Score Calculator and Freelance Rate Calculator. Numbers first, words second. That sequence prevents expensive promises.</p>
