...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildBlogArticleMetadata("/blog/invoice-generator-for-freelancers", locale, { en: enMeta, fr: frMeta, ar: arMeta });
}
...
export default async function Page() {
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16 text-gray-900">
      ...
      <p className="mb-6 leading-8 text-gray-700">If you want more context, review How to Price Freelance Work and Freelance Project Profit Explained. These guides connect pricing and delivery decisions to real profitability, which is the point of disciplined documentation.</p>
