...
export default async function Page() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 text-gray-900">
      ...
      <p className="mb-6 leading-8 text-gray-700">After drafting, pressure-test your economics with the Revenue Share Calculator and Decision Score Calculator. Numbers first, words second. That sequence prevents expensive promises.</p>
      <p className="mb-6 leading-8 text-gray-700">If you want more context, review What Is a Revenue Share Agreement and Revenue Share vs Profit Share. These guides connect pricing and delivery decisions to real profitability, which is the point of disciplined documentation.</p>
