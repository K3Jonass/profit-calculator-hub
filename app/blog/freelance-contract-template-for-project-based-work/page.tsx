...
const arMeta = {
  ...
  description:
    "قالب عقد عملي للمشاريع الثابتة يضبط التسليم والمراجعات والدفع بوضوح.",
};

export async function generateMetadata(): Promise<Metadata> {
  const locale = await getRequestLocale();
  return buildBlogArticleMetadata("/blog/freelance-contract-template-for-project-based-work", locale, { en: enMeta, fr: frMeta, ar: arMeta });
}
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16 text-gray-900">
      <h1 className="mb-6 text-4xl font-bold leading-tight">Freelance Contract Template for Project-Based Work: A Practical Operating Version</h1>
            ...
            <p className="mb-6 leading-8 text-gray-700">Freelance Contract Template for Project-Based Work: A Practical Operating Version is less about paperwork and more about operating discipline. Most teams that struggle with margin problems do not fail because demand is weak; they fail because execution is loose. A clean document system creates leverage: fewer clarifying calls, less rework, faster approvals, and stronger cash conversion.</p>
      <p className="mb-6 leading-8 text-gray-700">When people search for freelance contract template for project based work, they usually want a quick template. Templates help, but the bigger opportunity is installing a repeatable process around the document itself. The strongest operators treat every document as part of a revenue engine: it sets expectations, preserves decision history, and protects the economics of each deal.</p>
      ...
      <p className="mb-6 leading-8 text-gray-700">After drafting, pressure-test your economics with the Freelance Project Profit Calculator and Decision Score Calculator. Numbers first, words second. That sequence prevents expensive promises.</p>
      <p className="mb-6 leading-8 text-gray-700">If you want more context, review Hourly vs Project Pricing and How to Price Freelance Projects Profitably. These guides connect pricing and delivery decisions to real profitability, which is the point of disciplined documentation.</p>
      ...
      <p className="mb-6 leading-8 text-gray-700">
        Then continue with{" "}
        <Link href="/blog/freelance-hourly-vs-project" className="font-semibold text-blue-700 hover:text-blue-800">
