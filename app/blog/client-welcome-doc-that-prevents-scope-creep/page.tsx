...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildBlogArticleMetadata("/blog/client-welcome-doc-that-prevents-scope-creep", locale, { en: enMeta, fr: frMeta, ar: arMeta });
}
...
export default async function Page() {
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16 text-gray-900">
      ...
      <p className="mb-6 leading-8 text-gray-700">After drafting, pressure-test your economics with the Freelance Project Profit Calculator and Cost of Delay Calculator. Numbers first, words second. That sequence prevents expensive promises.</p>
      <p className="mb-6 leading-8 text-gray-700">If you want more context, review Freelance Project Profit Mistakes and Cost of Delay Examples. These guides connect pricing and delivery decisions to real profitability, which is the point of disciplined documentation.</p>
      ...
      <p className="mb-6 leading-8 text-gray-700">
        ...
        and{" "}
        <Link href="/blog/cost-of-delay-examples" className="font-semibold text-blue-700 hover:text-blue-800">
