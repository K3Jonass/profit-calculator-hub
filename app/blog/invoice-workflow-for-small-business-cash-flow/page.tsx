...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildBlogArticleMetadata("/blog/invoice-workflow-for-small-business-cash-flow", locale, { en: enMeta, fr: frMeta, ar: arMeta });
}
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16 text-gray-900">
      <h1 className="mb-6 text-4xl font-bold leading-tight">Invoice Workflow for Small Business Cash Flow: From Delivery to Collection</h1>
            ...
            <p className="mb-6 leading-8 text-gray-700">Invoice Workflow for Small Business Cash Flow: From Delivery to Collection is less about paperwork and more about operating discipline. Most teams that struggle with margin problems do not fail because demand is weak; they fail because execution is loose. A clean document system creates leverage: fewer clarifying calls, less rework, faster approvals, and stronger cash conversion.</p>
      <p className="mb-6 leading-8 text-gray-700">When people search for invoice workflow for small business cash flow, they usually want a quick template. Templates help, but the bigger opportunity is installing a repeatable process around the document itself. The strongest operators treat every document as part of a revenue engine: it sets expectations, preserves decision history, and protects the economics of each deal.</p>
      ...
      <p className="mb-6 leading-8 text-gray-700">For implementation, start with the ProfitHub generator: it gives you a practical baseline at /contracts/invoice, then adapt language to your offer and client profile.</p>
      <p className="mb-6 leading-8 text-gray-700">After drafting, pressure-test your economics with the Breakeven Calculator and Cost of Delay Calculator. Numbers first, words second. That sequence prevents expensive promises.</p>
      <p className="mb-6 leading-8 text-gray-700">If you want more context, review What Is a Breakeven Point and How to Calculate Cost of Delay. These guides connect pricing and delivery decisions to real profitability, which is the point of disciplined documentation.</p>
      ...
      <p className="mb-6 leading-8 text-gray-700">
        ...
        <Link href="/contracts/invoice" className="font-semibold text-blue-700 hover:text-blue-800">
          /contracts/invoice
        </Link>.
      </p>
