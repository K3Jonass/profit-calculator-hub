...
const arMeta = {
  ...
  description:
    "إطار تفاوض تعاقدي يحافظ على العلاقة ويثبت البنود التي تحمي الربحية.",
};

export async function generateMetadata(): Promise<Metadata> {
  const locale = await getRequestLocale();
  return buildBlogArticleMetadata("/blog/freelancer-contract-negotiation-guide", locale, { en: enMeta, fr: frMeta, ar: arMeta });
}
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16 text-gray-900">
      <h1 className="mb-6 text-4xl font-bold leading-tight">Freelancer Contract Negotiation Guide: Protect Margin Without Losing Great Clients</h1>
            ...
            <p className="mb-6 leading-8 text-gray-700">Freelancer Contract Negotiation Guide: Protect Margin Without Losing Great Clients is less about paperwork and more about operating discipline. Most teams that struggle with margin problems do not fail because demand is weak; they fail because execution is loose. A clean document system creates leverage: fewer clarifying calls, less rework, faster approvals, and stronger cash conversion.</p>
      <p className="mb-6 leading-8 text-gray-700">When people search for freelancer contract negotiation guide, they usually want a quick template. Templates help, but the bigger opportunity is installing a repeatable process around the document itself. The strongest operators treat every document as part of a revenue engine: it sets expectations, preserves decision history, and protects the economics of each deal.</p>
      ...
      <p className="mb-6 leading-8 text-gray-700">For implementation, start with the ProfitHub generator: it gives you a practical baseline at /contracts/freelancer, then adapt language to your offer and client profile.</p>
      <p className="mb-6 leading-8 text-gray-700">After drafting, pressure-test your economics with the Freelance Rate Calculator and Cost of Delay Calculator. Numbers first, words second. That sequence prevents expensive promises.</p>
      <p className="mb-6 leading-8 text-gray-700">If you want more context, review Freelance Income Goals and How to Calculate Cost of Delay. These guides connect pricing and delivery decisions to real profitability, which is the point of disciplined documentation.</p>
      ...
      <p className="mb-6 leading-8 text-gray-700">
        ...
        <Link href="/contracts/freelancer" className="font-semibold text-blue-700 hover:text-blue-800">
      ...
      <p className="mb-6 leading-8 text-gray-700">
        ...
        <Link href="/calculators/freelance-rate" className="font-semibold text-blue-700 hover:text-blue-800">
          Freelance Rate Calculator
        </Link>{" "}
        and{" "}
        <Link href="/calculators/cost-of-delay" className="font-semibold text-blue-700 hover:text-blue-800">
      ...
      <p className="mb-6 leading-8 text-gray-700">
        Then continue with{" "}
        <Link href="/blog/freelance-income-goals" className="font-semibold text-blue-700 hover:text-blue-800">
          Freelance Income Goals
        </Link>{" "}
        and{" "}
        <Link href="/blog/how-to-calculate-cost-of-delay" className="font-semibold text-blue-700 hover:text-blue-800">
