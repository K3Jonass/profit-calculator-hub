...
import InvoiceGeneratorForm from "@/components/contracts/InvoiceGeneratorForm";
...
export default function InvoiceGeneratorPage() {
  ...
  async function handleGenerate(values: InvoiceFormValues) {
    try {
      setIsLoading(true);
      setError("");
      setContractText("");
        ...
        <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg leading-8 text-slate-600">
              Generate a clean, professional invoice template in around 60
              seconds. Built for freelancers, operators, and small teams.
            </p>

            <p className="mt-3 text-sm leading-6 text-slate-500">
              This tool creates a practical invoice template based on your
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="mb-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Fill in the billing details and ProfitHub will generate a
                ready-to-use invoice template.
              </p>
            </div>

            <InvoiceGeneratorForm onSubmit={handleGenerate} isLoading={isLoading} />
