...
export default function HomePageClient() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10 md:px-6 md:py-14">
      <section className="rounded-[2rem] border border-slate-200 bg-slate-950 px-6 py-14 text-white shadow-sm md:px-10 md:py-16">
      ...
      <section className="mt-14" id="popular-calculators">
      ...
      <section className="mt-14">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          {useCases.map((useCase) => (
            <Link key={useCase.title} href={useCase.href} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:border-blue-200 hover:shadow-md">
      ...
      <section className="mt-14">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {latestGuides.map((post) => (
            <Link key={post.href} href={post.href} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:-translate-y-0.5 hover:shadow-md">
      ...
      <section className="mt-14">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          {featuredTools.map((tool) => (
            <Link key={tool.href} href={tool.href} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:border-blue-200 hover:shadow-md">
      ...
      <section className="mt-14 rounded-3xl border border-blue-200 bg-blue-50 px-6 py-10">
